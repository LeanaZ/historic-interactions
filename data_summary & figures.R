...
# read in data
dat <-read.csv("data/InteractionData_Silen.csv")
setDT(dat)
...
length(levels(dat$animalScientificName))             # 173 insect taxa
...
length(unique(dat_family$animalScientificName))      #  6 taxa resolved to species level
